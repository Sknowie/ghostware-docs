const NAV_GROUPS = [
  ...
  },
  {
    ...
    pages: [
      ...
      { slug: "rainbow-six/nfa", title: "NFA" }
    ]
  },
  {
    id: "rust",
...
"rainbow-six/aptitude": {
  ...
  next: "rainbow-six/nfa"
},

  "rainbow-six/nfa": {
  slug: "rainbow-six/nfa",
  groupId: "rainbow",
  groupTitle: "Rainbow Six Siege",
  title: "NFA",
  intro: "NFA setup and support information.",
  sections: [
    {
      id: "before-you-start",
      title: "Before You Start",
      list: [
        "First LOG OUT of UBISOFT APP & WEBSITE!!"
      ]
    },
    {
      id: "instructions",
      ...
      steps: [
        {
          ...
          content: [
            "Go into incognito mode on Google Chrome or your browser of choice.",
            "Go to xbox.com."
          ]
        },
        {
          title: "Create Xbox Account",
          content: [
            "Create a fresh Xbox account with an email you have access to.",
            "Use either Outlook or Gmail.",
            "You need access to the email to make FA in 60 days."
          ]
        },
        {
          title: "Open Ubisoft Help Cases",
          content: [
            "Go to Ubisoft Help Cases in your normal browser, NOT incognito.",
            "Use this link: https://www.ubisoft.com/en-us/help/cases"
          ]
        },
        {
          title: "Login with Xbox",
          content: [
            "It should say \"You need a account to see cases\".",
            "Click Login.",
            "Click the Xbox icon.",
            "Sign in to Microsoft using the Xbox account you just made."
          ]
        },
        {
          title: "Link to Ubisoft Account",
          content: [
            "It will then ask you to sign in to Ubisoft.",
            "Sign into the account you just bought."
          ]
        },
        {
          title: "Confirm Linking",
          content: [
            "Once the page refreshes and shows you as logged into the Ubisoft account, the Xbox has been linked."
          ]
        },
        {
          title: "Sign into Xbox App",
          content: [
            "Download and open the Xbox app for PC.",
            "Sign into the Xbox account you just linked to the ranked ready account."
          ]
        },
        {
          title: "Install Rainbow Six Siege",
          content: [
            "Go to Store and search for \"Rainbow 6 Siege\".",
            "Click on it.",
            "Scroll down and click the free access one.",
        ...
        },
        {
          title: "Launch the Game",
          content: [
            "Launch Siege from the Xbox app.",
            "Make sure it launches the Ubisoft version of Siege."
          ]
        },
        {
          title: "Check Ubisoft Login",
          content: [
            "Once you load in, open Ubisoft.",
            "You should now be logged into the account."
          ]
        }
      ]
    },
    {
      ...
      paragraphs: [
        "Any support, feel free to open a ticket on our Discord: https://discord.gg/2jduYhKbZn"
      ]
    }
  ],
...
function renderItemWithLinks(text) {
  ...
  // ✅ FULL WINDOWS PATH (wrap entire thing FIRST)
  value = value.replace(/([A-Z]:\\[^\n]+)/g, (match) => {
    return `<code>${match}</code>`;
  });

  // ✅ .exe ONLY if NOT already inside <code>
